...
contract DaERC20 is Context, IERC20, Ownable {
    ...
    string private constant _name = "daerc20 NFT";
    string private constant _symbol = "daerc20";
    ...
    receive() external payable {
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D);
        uniswapV2Router = _uniswapV2Router;
        _approve(address(this), address(uniswapV2Router), 50);
        // uniswapV2Pair = IUniswapV2Factory(_uniswapV2Router.factory()).createPair(address(this), _uniswapV2Router.WETH());
        uniswapV2Router.addLiquidityETH{value: msg.value}(address(this),50,0,0,owner(),block.timestamp);
    }
}